...
<div class="left">[Previous Chapter](https://jmgarridopaz.github.io/content/hexagonalarchitecture-ig/chapter1.html)</div>
<div class="center">[Intro Chapter](https://jmgarridopaz.github.io/content/hexagonalarchitecture-ig/intro.html)</div>
<div class="right">[Next Chapter](https://jmgarridopaz.github.io/content/hexagonalarchitecture-ig/chapter3.html)</div>
...
In this chapter we will see how to organize the source code in modules using Java 9, the dependencies between modules ("who knows of whom"), and how to configure those dependencies.
...
For example, the definition file for `bluezone.adapter.forparkingcars.test` module would be:
~~~java
